    ...
    <div class="row align-items-center">
        <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
            <div class="bg-primary position-relative overflow-hidden">
                <img src="{{ asset('img/offer-3.jpg') }}" class="img-fluid w-100" alt="">
        ...
        <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
            <div>
                <p class="">
                    <h3 class="fw-bold mb-4">Mission</h3>
...
<div class="container pb-4">
    <div class="row align-items-center">
        <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
            <div>
                <h3 class="fw-bold mb-4">Vision</h3>
                <p class="">
                    Established in 2018 and headquartered in Dubai, UAE, with a branch in London, GoAKW Consultants
                    has quickly gained recognition as an award-winning leader in governance, risk and compliance,
                    audit, tax advisory, financial accounting, transaction advisory, sustainability and responsible
        ...
        <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
            <div class="bg-primary position-relative overflow-hidden">
                <img src="{{ asset('img/offer-4.jpg') }}" class="img-fluid w-100" alt="">
                <div class="" style="position: absolute; top: -20px; left: 10px; transform: rotate(90deg);">
                </div>
            </div>
        </div>
...
<section class="py-5">
    <div class="container">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            <h1 class="display-5 mb-4">Our Core Values</h1>
        </div>
        <div class="row align-items-center">
            <div class="col-xl-3 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="position-relative">
                    ...
                    <div class="position-absolute top-50 start-50 translate-middle text-white text-center">
                        <h4 class=" fw-bold text-white">Core Values</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 wow fadeInLeft" data-wow-delay="0.2s">
...
<section class="py-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                <h4>Managing Partner & CEO</h4>
                <h1>Name Goes</h1>
                <p>
                    'Name' serves as the Managing Partner & CEO of AKW Consultants, bringing a wealth of experience and expertise to the organisation. With over 23 years of global experience in financial crime compliance, anti-money laundering, tax advisory, and auditing, Faisal is a distinguished Chartered Accountant.
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            <h1 class="display-5 mb-4">Our Directors</h1>
        </div>
